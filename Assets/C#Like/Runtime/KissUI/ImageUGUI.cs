/*
 * This file duplicate from "com.unity.ugui@1.0.0\Runtime\UI\Core\Image.cs", copyright owned by Unity Technologies.
 * Why not using that file directly? Because KissImage MUST modify this file,
 * or else will cause error "Could not extract GUID in text file *.unity at line ???" when using KissImage,
 * due to the editor save the sprite get from SpriteAtlas that CANT be serialized.
 * Changed log (By RongRong):
 *  1 Class name : Image -> ImageUGUI
 *  2 Mark as a abstract class
 *  3 Remove the "[SerializeField]" before "protected Sprite m_Sprite;" and some related with that m_Sprite.
 * 
 * 本文件复制自"com.unity.ugui@1.0.0\Runtime\UI\Core\Image.cs",版权归Unity所有.
 * 为什么不直接调用?因为KissImage必须修改本文件,
 * 否则使用KissImage时候会报错"Could not extract GUID in text file *.unity at line ???".
 * 因为编辑器保存了从精灵图集获取的精灵,该精灵不应该被保存.
 * 修改内容(由容容修改):
 *  1 类名 : Image -> ImageUGUI
 *  2 标识该类为抽象类
 *  3 移除"protected Sprite m_Sprite;"前面的"[SerializeField]"及相关修改
 */
...
namespace UnityEngine.UI
{
    ...
    /// </summary>
    public abstract class ImageUGUI : MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
    {
        /// <summary>
        ...
        public Sprite overrideSprite
        {
            ...
            set
            {
                if (SetPropertyUtilityUGUI.SetClass(ref m_OverrideSprite, value))
                {
                    SetAllDirty();
                    TrackSprite();
                }
        ...
        /// </remarks>
        public Type type { get { return m_Type; } set { if (SetPropertyUtilityUGUI.SetStruct(ref m_Type, value)) SetVerticesDirty(); } }
        ...
        /// </summary>
        public bool preserveAspect { get { return m_PreserveAspect; } set { if (SetPropertyUtilityUGUI.SetStruct(ref m_PreserveAspect, value)) SetVerticesDirty(); } }
        ...
        /// </code>
        /// </example>
        public bool fillCenter { get { return m_FillCenter; } set { if (SetPropertyUtilityUGUI.SetStruct(ref m_FillCenter, value)) SetVerticesDirty(); } }

        /// Filling method for filled sprites.
        [SerializeField] private FillMethod m_FillMethod = FillMethod.Radial360;
        public FillMethod fillMethod { get { return m_FillMethod; } set { if (SetPropertyUtilityUGUI.SetStruct(ref m_FillMethod, value)) { SetVerticesDirty(); m_FillOrigin = 0; } } }
        ...
        /// </code>
        /// </example>
        public float fillAmount { get { return m_FillAmount; } set { if (SetPropertyUtilityUGUI.SetStruct(ref m_FillAmount, Mathf.Clamp01(value))) SetVerticesDirty(); } }
        ...
        /// </code>
        /// </example>
        public bool fillClockwise { get { return m_FillClockwise; } set { if (SetPropertyUtilityUGUI.SetStruct(ref m_FillClockwise, value)) SetVerticesDirty(); } }
        ...
        /// </code>
        /// </example>
        public int fillOrigin { get { return m_FillOrigin; } set { if (SetPropertyUtilityUGUI.SetStruct(ref m_FillOrigin, value)) SetVerticesDirty(); } }
        ...
        /// </remarks>
        public bool useSpriteMesh { get { return m_UseSpriteMesh; } set { if (SetPropertyUtilityUGUI.SetStruct(ref m_UseSpriteMesh, value)) SetVerticesDirty(); } }
        ...
        static List<ImageUGUI> m_TrackedTexturelessImages = new List<ImageUGUI>();
        ...
        private static void TrackImage(ImageUGUI g)
        {
            if (!s_Initialized)
            {
        ...
        private static void UnTrackImage(ImageUGUI g)
        {
