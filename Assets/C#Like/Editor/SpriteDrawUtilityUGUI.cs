/*
 * This file duplicate from "com.unity.ugui@1.0.0\Editor\UI\SpriteDrawUtility.cs", copyright owned by Unity Technologies.
 * Why has to duplicate? Because it's a internal class.
 * Changed log (By RongRong):
 *  1 Class name : SpriteDrawUtility -> SpriteDrawUtilityUGUI
 * 
 * 本文件复制自"com.unity.ugui@1.0.0\Editor\UI\SpriteDrawUtility.cs",版权归Unity所有.
 * 为何要复制出来?因为它设定为内部类.
 * 修改内容(由容容修改):
 *  1 类名 : SpriteDrawUtility -> SpriteDrawUtilityUGUI
 */
...
namespace UnityEditor.UI
{
    ...
    /// </summary>
    internal class SpriteDrawUtilityUGUI
    {
